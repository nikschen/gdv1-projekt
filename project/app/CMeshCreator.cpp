...
void CMeshCreator::CreateLeftAndRightLevelBorder(BHandle* _ppMesh)
{
    ...
    float colors[][4] =
    {
        { 128.0f, 128.0f, 128.0f, 1.0f, },        // Color of vertex 0.
        { 128.0f, 128.0f, 128.0f, 1.0f, },        // Color of vertex 1.
        { 128.0f, 128.0f, 128.0f, 1.0f, },        // Color of vertex 2.
        { 128.0f, 128.0f, 128.0f, 1.0f, },        // Color of vertex 3.
    };
